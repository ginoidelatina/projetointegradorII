...
def plotData(df1, options):
    ...
    if ('Idade' in options):
        ...
        with col1:
            st.code('Quantidade de alunos por idade, dados organizados por ordem de valor (Rol).')  
        ...
        with col2:
            st.code('Quantidade de alunos por idade, dados organizados por frequência.')
        ...
        del valage, valage1, data_temp, axi
